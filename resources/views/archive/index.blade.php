            ...
            <form method="GET" action="{{ route('archive.index') }}" class="flex flex-col lg:flex-row gap-3">
                ...
                <div class="flex-1">
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text" name="start_date" value="{{ request('start_date') }}" readonly
                ...
                <div class="flex-1">
                    <div class="relative max-w-sm">
                        ...
                        <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text" name="end_date" value="{{ request('end_date') }}" readonly
