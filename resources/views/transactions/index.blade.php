                ...
                <div class="flex flex-col lg:flex-row gap-3">
                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text" name="start_date" value="{{ request('start_date') }}" onchange="this.form.submit()" readonly
                    ...
                    <div class="flex-1">
                        ...
                        <div class="relative max-w-sm">
                            ...
                            <input datepicker datepicker-autohide datepicker-format="yyyy-mm-dd" type="text" name="end_date" value="{{ request('end_date') }}" onchange="this.form.submit()" readonly
                                   class="w-full bg-background border border-border text-foreground text-sm rounded-lg p-2.5 ps-10 block focus:ring-1 focus:ring-[#5D5FEF] focus:border-[#5D5FEF]" placeholder="Pilih tanggal">
                        </div>
                    </div>
