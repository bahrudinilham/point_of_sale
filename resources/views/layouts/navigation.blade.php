<nav x-data="{ open: false }" x-init="$watch('open', value => window.dispatchEvent(new CustomEvent('mobile-menu-toggle', { detail: { open: value } })))" class="bg-card border-b border-border relative z-50">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-1 lg:-my-px lg:ms-8 lg:flex items-center">
                    ...
                    {{-- Produk - accessible by admin and cashier --}}
        ...
        <div class="absolute inset-x-0 top-0 z-50 flex flex-col w-full bg-card border-b border-border shadow-xl transform transition-transform"
            ...
            <div class="pt-4 pb-4 border-t border-border bg-background/50">
                ...
                <div class="mt-3 space-y-1 px-2">
                    ...
                    }" class="flex items-center justify-between px-4 py-3 text-base font-medium text-muted hover:text-foreground hover:bg-card rounded-lg cursor-pointer group" @click="toggle()">
                        <div class="flex items-center gap-3">
                            <div class="relative w-5 h-5">
                                ...
                                <svg x-show="darkMode" 
                                     ...
                                     x-transition:leave-start="opacity-100 rotate-0 scale-100"
                                     x-transition:leave-end="opacity-0 rotate-90 scale-0"
                                     class="w-5 h-5 absolute inset-0 text-indigo-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M20.354 15.354A9 9 0 018.646 3.646 9.003 9.003 0 0012 21a9.003 9.003 0 008.354-5.646z"></path>
                                </svg>
                            </div>
                            <span x-text="darkMode ? 'Mode Gelap' : 'Mode Terang'" class="transition-colors duration-200"></span>
                        </div>
                        {{-- Toggle Switch --}}
                        <div class="relative w-12 h-7 rounded-full transition-all duration-300 ease-out" 
                             :class="darkMode ? 'bg-[#5D5FEF] shadow-[0_0_12px_rgba(93,95,239,0.5)]' : 'bg-gray-300 dark:bg-gray-600'">
                            <div class="absolute top-1 left-1 w-5 h-5 bg-white rounded-full shadow-md transform transition-all duration-300 ease-[cubic-bezier(0.68,-0.55,0.265,1.55)] flex items-center justify-center" 
                                 :class="darkMode ? 'translate-x-5' : 'translate-x-0'">
                                {{-- Inner icon on the toggle ball --}}
                                <svg x-show="!darkMode" class="w-3 h-3 text-yellow-500" fill="currentColor" viewBox="0 0 20 20">
                                    <path fill-rule="evenodd" d="M10 2a1 1 0 011 1v1a1 1 0 11-2 0V3a1 1 0 011-1zm4 8a4 4 0 11-8 0 4 4 0 018 0zm-.464 4.95l.707.707a1 1 0 001.414-1.414l-.707-.707a1 1 0 00-1.414 1.414zm2.12-10.607a1 1 0 010 1.414l-.706.707a1 1 0 11-1.414-1.414l.707-.707a1 1 0 011.414 0zM17 11a1 1 0 100-2h-1a1 1 0 100 2h1zm-7 4a1 1 0 011 1v1a1 1 0 11-2 0v-1a1 1 0 011-1zM5.05 6.464A1 1 0 106.465 5.05l-.708-.707a1 1 0 00-1.414 1.414l.707.707zm1.414 8.486l-.707.707a1 1 0 01-1.414-1.414l.707-.707a1 1 0 011.414 1.414zM4 11a1 1 0 100-2H3a1 1 0 000 2h1z" clip-rule="evenodd"></path>
                                </svg>
                                <svg x-show="darkMode" class="w-3 h-3 text-indigo-400" fill="currentColor" viewBox="0 0 20 20">
